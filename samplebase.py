...
class SampleBase(object):
    ...
    def DrawLine(self, context, x1, y1, x2, y2, color):
        graphics.DrawLine(context, x1, y1, x2, y2, color)
    ...
    def DrawText(self, context, f, x, y, color, text):
        graphics.DrawText(context, f, x, y, color, text)
